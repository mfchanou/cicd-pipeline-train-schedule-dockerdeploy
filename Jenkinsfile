        ...
        stage('DeployToProduction') {
            ...
            steps {
                    ...
                    withCredentials([usernamePassword(credentialsId: 'webserver_login', usernameVariable: 'USERNAME', passwordVariable: 'USERPASS')]) {
                        ...
                        sh "sshpass -p '$USERPASS' ssh -o StrictHostKeyChecking=no $USERNAME@$ip_prod \"docker run --restart always --name train-schedule -p 8080:8080 -d mahfuz93/train-schedule:${env.BUILD_NUMBER} \""
                        }
                 }
            }
        }        
